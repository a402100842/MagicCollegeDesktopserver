...
public class BeginAttackClientMessage extends ClientMessage implements GameConstants{
	private String myID;
	...
	public short getFlag() {
		return FLAG_CLIENTMESSAGE_BEGINATTACK;
	}
...
//		ResourceManager.getInstance().activity.toastOnUIThread(str);
	}
